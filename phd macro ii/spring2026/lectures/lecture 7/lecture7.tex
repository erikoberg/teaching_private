...
\begin{frame}{US wage dispersion: update through 2024 (using Cursor and GPT)}
...
\bit
\item (tentative) fact: Little action since 2000
\eit
...
\begin{frame}{US residual wage dispersion: update through 2024 (using Cursor and GPT)}

\begin{figure}
	\centering
	\includegraphics[scale=0.45]{figures/acemoglu_2002_fig3_update_2024.pdf}
