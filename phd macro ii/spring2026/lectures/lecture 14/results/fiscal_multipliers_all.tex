...
\midrule
2. Less sticky prices ($\phi = 178$) & 1.0 [0.61] & 0.30 & 0.47 & 1.03 & 3.43 & 1.15 \\
3. More reactive mp ($\delta_\pi = 2$) & 1.0 [0.64] & 0.30 & 0.47 & 1.03 & 3.33 & 1.13 \\
\midrule
4. Representative agent & 1.0 [0.54] & 0.00 & 0.00 & 0.00 & 1.92 & 0.57 \\
5. Fewer HtM (17.4\%) & 1.0 [0.80] & 0.19 & 0.41 & 1.11 & 1.80 & 0.69 \\
6. More tax financing ($\omega = 0.10$) & 1.0 [0.84] & 0.19 & 0.40 & 1.10 & 1.70 & 0.67 \\
\midrule
7. Exo. separations ($\psi = 0$) & 1.0 [0.13] & 0.35 & 0.52 & 1.02 & 1.39 & 3.38 \\
