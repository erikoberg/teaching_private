...
options_ = [];
M_.fname = 'rbc_adjcost_collateralconstraint';
...
diary off;
diary('rbc_adjcost_collateralconstraint.log');
M_.exo_names = 'e';
M_.exo_names_tex = 'e';
M_.exo_names_long = 'e';
M_.endo_names = 'ahat';
...
M_.endo_names_tex = char(M_.endo_names_tex, 'Rhat');
M_.endo_names_long = char(M_.endo_names_long, 'Rhat');
M_.endo_names = char(M_.endo_names, 'logQhat');
M_.endo_names_tex = char(M_.endo_names_tex, 'logQhat');
M_.endo_names_long = char(M_.endo_names_long, 'logQhat');
...
M_.endo_names_tex = char(M_.endo_names_tex, 'muhat');
M_.endo_names_long = char(M_.endo_names_long, 'muhat');
...
M_.param_names = char(M_.param_names, 'phi_val');
M_.param_names_tex = char(M_.param_names_tex, 'phi\_val');
M_.param_names_long = char(M_.param_names_long, 'phi_val');
M_.param_names = char(M_.param_names, 'xi_val');
M_.param_names_tex = char(M_.param_names_tex, 'xi\_val');
M_.param_names_long = char(M_.param_names_long, 'xi_val');
...
M_.param_names = char(M_.param_names, 'Q_ss_val');
M_.param_names_tex = char(M_.param_names_tex, 'Q\_ss\_val');
M_.param_names_long = char(M_.param_names_long, 'Q_ss_val');
...
erase_compiled_function('rbc_adjcost_collateralconstraint_static');
erase_compiled_function('rbc_adjcost_collateralconstraint_dynamic');
M_.orig_eq_nbr = 12;
M_.eq_nbr = 12;
M_.ramsey_eq_nbr = 0;
...
save('rbc_adjcost_collateralconstraint_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('rbc_adjcost_collateralconstraint_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('rbc_adjcost_collateralconstraint_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('rbc_adjcost_collateralconstraint_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('rbc_adjcost_collateralconstraint_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('rbc_adjcost_collateralconstraint_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('rbc_adjcost_collateralconstraint_results.mat', 'oo_recursive_', '-append');
end
