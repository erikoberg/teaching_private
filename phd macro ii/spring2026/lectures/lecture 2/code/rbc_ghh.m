...
M_.param_names = char(M_.param_names, 'sigma_val');
M_.param_names_tex = char(M_.param_names_tex, 'sigma\_val');
M_.param_names_long = char(M_.param_names_long, 'sigma_val');
...
erase_compiled_function('rbc_ghh_static');
erase_compiled_function('rbc_ghh_dynamic');
M_.orig_eq_nbr = 8;
M_.eq_nbr = 8;
M_.ramsey_eq_nbr = 0;
...
save('rbc_ghh_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('rbc_ghh_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('rbc_ghh_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('rbc_ghh_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('rbc_ghh_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('rbc_ghh_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('rbc_ghh_results.mat', 'oo_recursive_', '-append');
end
