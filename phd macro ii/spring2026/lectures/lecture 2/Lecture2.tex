...
\bit
\setlength\itemsep{1.5em}
	\item Cesarini-Lindqvist-Notowidigdo-Östling (AER 2017): labor supply responses to windfall lottery gains very small
	...
	\setlength\itemsep{0.5em}
		...
		\item Broer-Harmenberg-Krusell-Öberg (AER:insights 2023): this is what you should expect if households are subject to rigid wage contracts
	\eit
\eit
...
\begin{frame}{Rigid-wage contracts a la Broer-Harmenberg-Krusell-Öberg}
