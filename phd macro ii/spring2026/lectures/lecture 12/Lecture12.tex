...
\item Three famous applications
\ben
\setlength\itemsep{0.5em}
...
\item Implication: a permanent-income rich household will consume the same amount of an increase in normalized cash-on-hand as a permanent-income poor household
\eit
...
\begin{frame}{Parameterization: method of moments}

\bit
\setlength\itemsep{1em}

\item Calibration of $\beta, \sigma, \underbar a$ is typically done by method of moments
\bit
\setlength\itemsep{0.5em}
...
\begin{frame}{Income process estimation: recent extensions}
...
\bit
	\item Guvenen-Karahan-Ozkan-Song (Ecmtra 2021): income growth residuals exhibit fat tails and significant skewness (normality is a bad assumption)
	...
	\item Harmenberg-Lizarraga (2025): a generalized square root process captures earnings dynamics at the top of the distribution very well
\eit
...
\bit
\setlength\itemsep{0.5em}
	\item Hump shape in consumption directly rejects that working-age households have full insurance - why?
\eit
...
\item Middle-aged households: already have a buffer and retirement is near $\Rightarrow$ saving primarily reflects consumption smoothing with respect to retirement
...
\bit
\setlength\itemsep{0.5em}
\item Both variance and autocovariance of income growth grew during the eighties, but autocovariance grew relatively more
\eit
...
\bit
\setlength\itemsep{1em}
\item Variance of consumption growth grew in the early eighties, then declined thereafter
\eit
...
\bit
\setlength\itemsep{1em}
\item Permanent-income inequality grew a lot in the eighties, then declined thereafter
\eit
...
\bit
\setlength\itemsep{1em}
\item Transitory-income inequality declined in the early eighties, then grew from the mid-eighties onward
\eit
...
\item The series diverged from the mid-eighties onward, as income inequality growth stemmed from transitory inequality growth, against which households are much more insured
\eit
...
\bit
\setlength\itemsep{0.5em}
	\item Commault (AEJmacro 2021): Natural experiment evidence suggests much less insurance to transitory income shocks; how does this square with BPP and other semi-structural estimation approaches? 
		\bit
		\setlength\itemsep{0.5em}
...
\setlength\itemsep{0.5em}
	...
	\item Straub (2019): Augmented BPP-like estimation procedure suggests consumption does not respond linearly to permanent-income shocks
		\bit
		\setlength\itemsep{0.5em}
			\item Poor households respond more, rich households less
...
\bit
\setlength\itemsep{1em}
\item In conventional (rep-agent) macro models, MPC is low, and fluctuations in income therefore play little role for fluctuations in aggregate demand
\bit
\setlength\itemsep{0.5em}
...
\item Recent exploratory approaches to understanding heterogeneity in MPC 
\bit
	\item Aguiar-Bils-Boar (REStud 2025), Colarieti-Mei-Stantcheva (2025), Carlsson-D'Amico-{\"O}berg-Skans-Walentin (2025)
\eit
\eit
