...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_current(5,1)=5; nzij_current(5,2)=3;
  ...
  nzij_current(12,1)=7; nzij_current(12,2)=6;
  nzij_current(13,1)=2; nzij_current(13,2)=7;
  nzij_current(14,1)=6; nzij_current(14,2)=7;
  nzij_fwrd = zeros(3, 2, 'int32');
  nzij_fwrd(1,1)=3; nzij_fwrd(1,2)=1;
  nzij_fwrd(2,1)=4; nzij_fwrd(2,2)=2;
  nzij_fwrd(3,1)=5; nzij_fwrd(3,2)=2;
end
