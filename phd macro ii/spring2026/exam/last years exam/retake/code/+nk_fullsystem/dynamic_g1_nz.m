...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_pred(1,1)=1; nzij_pred(1,2)=10;
  nzij_pred(2,1)=3; nzij_pred(2,2)=11;
  ...
  nzij_current(16,1)=5; nzij_current(16,2)=7;
  nzij_current(17,1)=10; nzij_current(17,2)=7;
  nzij_current(18,1)=2; nzij_current(18,2)=8;
  nzij_current(19,1)=10; nzij_current(19,2)=8;
  nzij_current(20,1)=2; nzij_current(20,2)=9;
  nzij_current(21,1)=3; nzij_current(21,2)=9;
  ...
  nzij_current(25,1)=12; nzij_current(25,2)=12;
  nzij_fwrd = zeros(4, 2, 'int32');
  nzij_fwrd(1,1)=12; nzij_fwrd(1,2)=2;
  nzij_fwrd(2,1)=2; nzij_fwrd(2,2)=7;
  nzij_fwrd(3,1)=5; nzij_fwrd(3,2)=7;
