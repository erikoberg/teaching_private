...
parameters sigma_val alpha_val beta_val delta_val theta_val varphi_val std_a_val rho_a_val R_ss_val CY_ss_val IY_ss_val;
varexo e;
...
sigma_val*chat = -(R_ss_val/(R_ss_val+(1-delta_val)))*rhat(+1) + sigma_val*chat(+1);
