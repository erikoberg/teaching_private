...
\linespread{1.5}
\usepackage{fullpage}
\usepackage{amsmath,amssymb,amsthm,graphicx,pgfplots,tabularx,placeins}
...
Send your solutions to Andrii by \textbf{March 12, 12.00} at the latest.
...
\begin{eqnarray}
U_0 = E_0 \sum_{t=0}^{\infty} \beta^t \left[U(C_t)-V(N_t)\right], \nonumber
\end{eqnarray}
