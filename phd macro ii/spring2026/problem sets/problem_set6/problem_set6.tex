...
% (No bibliography in this problem set; avoid triggering BibTeX via bibentry.)
...
Send your solutions to Andrii by \bf March 26, 12.00 \normalfont at the latest.
...
\begin{eqnarray}
\max_{N_t, I_t, K_{t+1}} && E_0 \sum_{t=0}^{\infty} M_{0, t} \left(A_t F(K_t, N_t) - W_t N_t - I_t - C(I_t, K_t) \right) \nonumber \\
