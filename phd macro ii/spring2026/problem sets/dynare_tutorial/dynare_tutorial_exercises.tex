...
Going forward to analyze dynamics, let's set $\rho_a=0.973$ and $\sigma_{\epsilon}=0.009$.
\ben
	\item Plug in the log-linear system into Dynare and simulate a first-order pertubation
	
	\item Compare your estimated IRFs with those we retreived in class, are they the same?
...
\section*{Exercise 3: Making you own graphs using the IRFs}
\ben
